<template>
  <!-- <div class="mobilecard card">
	...
	<img class="img_card" :src="require('@/assets/bookcovers/'+ book.book_id+'.jpg')" alt="Image">
</li>
</ul>
</div>
...
<img :class="'img_card_'+index" :src="require('@/assets/bookcovers/'+ book.book_id+'.jpg')" alt="Image">
</li>
</ul>
</div>
...
export default {
  ...
  mounted() {
    ...
    if (this.id == "popular") this.datalink = "/books/popularbooks";
    else if (this.id == "favorite") this.datalink = "/books/favoritebooks";
