<template>
  <ul class="previewcard">
    <li class="previewcardTitle" :style="cssVars">
      <a> {{ title }} </a>
    </li>
    <li
    ...
    >
      <div class="carousel-inner">
        <div
          ...
          :key="n"
          :class="{ 'carousel-item active': n == 1, 'carousel-item': n != 1 }"
        >
            ...
            >
              ...
              <div
                :id="
                  ...
                  'addtocart'
                "
                class="book-add-to-cart"
              >
                <button
                  class="btn cd-add-to-cart js-cd-add-to-cart"
              ...
              <div class="book-brief">
                ...
                <span
                  class="book-author"
                  v-text="book.authors[0]['author_name']"
                ></span>
                <div class="book-rating">
                  <span
                    :class="{
                      'fa fa-star checked': book.book_ranking >= 2,
                      'fa fa-star': book.book_ranking < 2,
                    }"
                  ></span>
                  <span
                    :class="{
                      'fa fa-star checked': book.book_ranking >= 4,
                      'fa fa-star': book.book_ranking < 4,
                    }"
                  ></span>
                  <span
                    :class="{
                      'fa fa-star checked': book.book_ranking >= 6,
                      'fa fa-star': book.book_ranking < 6,
                    }"
                  ></span>
                  <span
                    :class="{
                      'fa fa-star checked': book.book_ranking >= 8,
                      'fa fa-star': book.book_ranking < 8,
                    }"
                  ></span>
                  <span
                    :class="{
                      'fa fa-star checked': book.book_ranking >= 10,
                      'fa fa-star': book.book_ranking < 10,
                    }"
                  ></span>
                </div>
                <span
                  class="book-price"
                  v-text="'BDT ' + book.book_price"
                ></span>
              </div>
      ...
      <a
        ...
        :id="prefix + 'carousel-control-prev'"
        class="carousel-control-prev"
        :href="'#' + prefix + 'carousel'"
        data-slide="prev"
      >
      ...
      <a
        style="visibility: hidden"
        :id="prefix + 'carousel-control-next'"
...
export default {
  ...
  mounted() {
    if (this.prefix == "popularbook") this.datalink = "/books/popularbooks";
    else if (this.prefix == "favoritebook")
      this.datalink = "/books/favoritebooks";
    else this.datalink = "/books/allbooks";
    this.loadData();
  },
  methods: {
