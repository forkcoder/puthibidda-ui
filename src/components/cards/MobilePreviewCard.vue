<template>
  <ul class="mobilepreviewcard">
    <li class="mobilepreviewcardTitle" :style="cssVars">
      <a> {{ title }} </a>
    </li>
    <li
      :id="prefix + 'carousel'"
...
export default {
  ...
  mounted() {
    ...
    else if (this.prefix == "humaunbooks") this.datalink = "/books/author/1";
    else if (this.prefix == "saratbooks") this.datalink = "/books/author/2";
    else if (this.prefix == "satajitbooks") this.datalink = "/books/author/4";
