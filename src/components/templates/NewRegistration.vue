              ...
              <div class="row register-form">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <select
                      id="library_state"
                      v-model="library_state"
                      name="library_state"
                      v-on:change="updatedDistricts()"
                      required
                      autofocus
                      type="text"
                      class="form-control"
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="custom-file">
                        <input
                          ...
                          autofocus
                        />
                        <label class="custom-file-label" for="library_cover"
                          >ছবি *</label
                        >
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <select
                      id="library_payment_type"
                      v-model="library_payment_type"
                      name="library_payment_type"
                      required
                      autofocus
                      class="form-control"
                      single
                    >
                      <option value="" disabled selected>
                        <span>বিনিময়ের ধরন * </span>
                      </option>
                      <option
                        v-for="(item, key) in payment_type"
                        :key="key"
                        :value="key"
                      >
                        <span>{{ item }}</span>
                  ...
                  <div class="form-group">
                    <select
                      id="library_preferences"
                      v-model="library_preferences"
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input
                      id="library_contactno"
                      v-model="library_contactno"
                      name="library_contactno"
                      required
                      autofocus
                      type="text"
                      minlength="11"
                  ...
                  <div class="form-group">
                    <input
                      id="library_telephone"
                      v-model="library_telephone"
                      name="library_telephone"
                      type="text"
                      maxlength="50"
                      class="form-control"
                      placeholder="টেলিফোন নং"
                    />
                  </div>
                  <div class="form-group">
                    <input
                      id="library_est_date"
                      v-model="library_est_date"
                      name="library_est_date"
                      class="form-control"
                      type="text"
                      onfocus="(this.type='date')"
                      onblur="(this.type='text')"
                      placeholder="স্থাপনাকাল *"
                    />
                  </div>
                  ...
                  <div class="form-group">
                    <input
                      id="library_password_confirmation"
                      v-model="library_password_confirmation"
                      name="library_password_confirmation"
                      type="password"
                      class="form-control"
              ...
              <div class="card">
                <div class="row">
                  ...
                  <div class="col-md-7 profileinfo">
                    <p>
                      <strong>ঠিকানা/অবস্থানঃ </strong>
                      {{ library_info["library_address"] }}
                    </p>
                    <p>
                      <strong>জেলার নামঃ </strong>
                      {{ library_info["library_district"] }}
                    </p>
                    <p>
                      <strong>বিভাগের নামঃ </strong>
                      {{ library_info["library_state"] }}
                    </p>
                    <p>
                      <strong>বিনিময়ের ধরণঃ </strong>
                      {{ payment_type[library_info["library_payment_type"]] }}
                    </p>
                    <p>
                      <strong>মালিকের নামঃ </strong>
                      {{ library_info["library_owner"] }}
                    </p>
                    <p>
                      <strong>মোবাইল নং- </strong>
                      {{ library_info["library_contactno"] }}
                    </p>

                    <p>
                      <strong>টেলিফোন নং- </strong>
                      {{ library_info["library_telephone"] }}
                    </p>
                    <p>
                      <strong>স্থাপন কালঃ </strong>
                      {{ library_info["library_est_date"] }}
                    </p>
                    <p>
                      <strong>বইয়ের ধরণঃ</strong>
                      {{ library_info["library_preferences"] }}
                    </p>
                  </div>
                </div>
                <button
    ...
    <div class="modal fade" id="agreementModel" role="dialog">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">Faisal Try to write sth here.</div>
...
export default {
  ...
  data: function () {
    return {
      ...
      payment_type: {
        cash: "নগদ ক্যাশ",
        cash_card: "নগদ ক্যাশ এবং পেমেন্ট কার্ড",
        cash_card_bkash: "নগদ ক্যাশ, পেমেন্ট কার্ড এবং বিকাশ",
      },
      csrf: document
  ...
  methods: {
    initialize: function () {
      ...
      select
        ...
        .on("change", () => {
          this.library_preferences = select.val();
        });
    },
    ...
    handleFileUpload() {
      ...
      else this.isUploaded = "fa fa-check-square";
    ...
    checkAndSubmit: function (e) {
      ...
      formData.append(
        "library_password_confirmation",
        this.library_password_confirmation
      );
