      ...
      <div class="modal fade" id="book-detail" role="dialog">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <ol class="breadcrumb">
              <li
                v-if="bookdetail.category.category_title"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.categories[bookdetail.category.category_title]
                }}</a>
              </li>
              <li
                v-if="bookdetail.category.category_class != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.classes[bookdetail.category.category_class]
                }}</a>
              </li>
              <li
                v-if="bookdetail.category.category_year != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.years[bookdetail.category.category_year]
                }}</a>
              </li>

              <li
                v-if="bookdetail.category.category_semester != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.semesters[bookdetail.category.category_semester]
                }}</a>
              </li>

              <li
                v-if="bookdetail.category.category_part != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.parts[bookdetail.category.category_part]
                }}</a>
              </li>

              <li
                v-if="bookdetail.category.category_session != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.sessions[bookdetail.category.category_session]
                }}</a>
              </li>

              <li
                v-if="bookdetail.category.category_favorite != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.favorites[bookdetail.category.category_favorite]
                }}</a>
              </li>
              <li
                v-if="bookdetail.category.category_relation != '1'"
                class="breadcrumb-item"
              >
                <a href="#">{{
                  appdetail.relations[bookdetail.category.category_relation]
                }}</a>
              </li>
              ...
              <div class="foldtl col-md-12 page">
                <div class="store-body">
                  <div class="book_description">
                    ...
                    <span class="salePercentage" style="margin-top: 15px"
                      >40%</span
                    >
                  ...
                  <div class="product">
                    <div class="make3D">
                      <div class="product-front">
                        ...
                        <img
                          :src="require('@/assets/bookcovers/' + bookdetail.book_cover)"
                        />
                        ...
                        <div class="carousel">
                          <ul class="carousel-container">
                            <li>
                              <img
                                :src="
                                  require('@/assets/bookcovers/' + bookdetail.book_cover)
                                "
                              />
                            </li>
                            <li>
