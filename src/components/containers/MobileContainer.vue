  ...
  <ul class="mobilecontainer">
      ...
      <nav id="searchbarNavbar" class="navbar navbar-laravel">
        ...
        <li class="searchmodule">
          <div id="book-search-form">
            <input
              type="text"
              placeholder="Search for Books by Title/ Keyword/ Author"
    ...
    <ul v-if="categorypage == -1" class="mCategories">
      <li v-for="(category, index) in categories" :key="index" class="itemDiv">
        <div
          @click="
            selectCategory(index, category.name, category.color, category.src)
          "
        >
          <img
            style="
    ...
    <mobile-panel
      ...
      v-on:loaddetailfunction="loadDetailFunction"
      :categorypage="categorypage"
      :categoryTitle="selectedCategory"
      :categoryColor="selectedColor"
      :categoryLogo="selectedLogo"
    ></mobile-panel>
  </ul>
</template>
<script>
...
#book-search-form {
  ...
  /* Shadows */
  box-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3), 0 0 2px rgba(0, 0, 0, 0.3);
  -webkit-box-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3), 0 0 2px rgba(0, 0, 0, 0.3);
  -moz-box-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3), 0 0 2px rgba(0, 0, 0, 0.3);
}
/*** TEXT BOX ***/
.book-search {
  ...
  /* Shadows */
  box-shadow: -1px -1px 2px rgba(0, 0, 0, 0.3), 0 0 1px rgba(0, 0, 0, 0.2);
  -webkit-box-shadow: -1px -1px 2px rgba(0, 0, 0, 0.3),
    0 0 1px rgba(0, 0, 0, 0.2);
  -moz-box-shadow: -1px -1px 2px rgba(0, 0, 0, 0.3), 0 0 1px rgba(0, 0, 0, 0.2);
}
