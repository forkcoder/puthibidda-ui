<template>
  <li class="basepanel">
    ...
    ></desktop-card>
    <preview-card
      v-if="cards['preview-card'] == 1"
      :uxmenu="uxmenu"
      :title="uxmenu['popularbooks']"
      v-on:addtocart="addToCart"
      v-on:bookdetail="showDetail"
      prefix="popularbook"
      :titleColor="'#112255'"
    ></preview-card>
    <preview-card
    ...
    <detail-card
      v-if="cards['detail-card'] == 1"
      :bookdetail="bookdetail"
      v-on:addtocart="addToCart"
      v-on:loaddetailfunction="loadDetailFunction"
    ></detail-card>
    <preview-card
      v-if="cards['relatedbook-card'] == 1"
      :uxmenu="uxmenu"
      title="Related Books"
      v-on:addtocart="addToCart"
      v-on:bookdetail="showDetail"
